...
interface AperocketBananaInterface extends ethers.utils.Interface {
  functions: {
    "SPACE()": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "SPACE", values?: undefined): string;
  ...
  encodeFunctionData(functionFragment: "spaceChef", values?: undefined): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "SPACE", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "spaceChef", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "stakingToken",
    data: BytesLike
  ): Result;
  ...
  events: {
    ...
    "SpacePaid(address,uint256,uint256)": EventFragment;
  ...
  getEvent(nameOrSignatureOrTopic: "SpacePaid"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Whitelisted"): EventFragment;
  getEvent(nameOrSignatureOrTopic: "Withdrawn"): EventFragment;
}

export class AperocketBanana extends Contract {
  ...
  interface: AperocketBananaInterface;

  functions: {
    SPACE(overrides?: CallOverrides): Promise<[string]>;
    ...
    spaceChef(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    SPACE(overrides?: CallOverrides): Promise<BigNumber>;
    ...
    spaceChef(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    SPACE(overrides?: CallOverrides): Promise<PopulatedTransaction>;
    ...
    spaceChef(overrides?: CallOverrides): Promise<PopulatedTransaction>;
